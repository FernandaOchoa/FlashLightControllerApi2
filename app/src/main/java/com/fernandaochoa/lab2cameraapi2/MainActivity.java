package com.fernandaochoa.lab2cameraapi2;
...
import com.fernandaochoa.lab2cameraapi2.R;
...
public class MainActivity extends Activity {
    ...
    private void init() throws CameraAccessException {
        ...
        } else Toast.makeText(MainActivity.this, "Flash not available", Toast.LENGTH_SHORT).show();
